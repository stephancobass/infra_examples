...
resource "aws_iam_role" "lambda_role" {
  name               = "${var.environment}-twitter-s3-lambda"
 ...
 "Statement": [
   ...
   },
   {
    ...
    },
    {
      ...
      "Effect": "Allow",
      "Resource": "arn:aws:secretsmanager:${var.aws_region}:521213957793:secret:*"
    }
 ]
}
EOF
    ...
    "Statement": [
        {
            ...
            "Resource": [
                "${aws_lambda_function.twitter_s3_lambda.arn}"
            ]
        },
        {
          "Action": [
...
#IAM for StepFunction scheduler
resource "aws_iam_role" "scheduler_role" {
  name               = "${var.environment}-twitter-s3-lambda-sfn-scheduler"
  assume_role_policy = <<EOF
    {
    "Version": "2012-10-17",
    "Statement": [
    ...
    "Statement": [
        {
            ...
            "Resource": [
                "${aws_sfn_state_machine.twitter_lambda_sfn_state_machine.arn}"
            ]
        }
    ]
}
